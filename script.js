// URLs das planilhas
const PLANILHA_ESTABELECIMENTO = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQGBMAcW_P5hyxfKMRZg1ORWjB-l7-VvLDvYtxSqwmIogF6LSFqrxwH0OsSm4O6baMjIANgu8bXsk5l/pub?gid=0&single=true&output=csv';
const PLANILHA_CATEGORIAS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSXuWKq5rQcszB5BLyNPH8JZLgeIXEz0QpssaaeOuhrJRQA8fmBwr-74W1T34CBKsrdZZAU2fTLcgS9/pub?gid=2046515958&single=true&output=csv';
const PLANILHA_ITENS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSXuWKq5rQcszB5BLyNPH8JZLgeIXEz0QpssaaeOuhrJRQA8fmBwr-74W1T34CBKsrdZZAU2fTLcgS9/pub?gid=634023530&single=true&output=csv';
...
function habilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        ...
        if (item && (item.disponivel === 'TRUE' || item.disponivel === true || item.disponivel === 'true')) {
            ...
            botao.classList.add('bg-blue-500', 'text-white', 'hover:bg-purple-600');
